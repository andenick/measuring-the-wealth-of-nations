"""L01_XS1402 — Load Productive Labor Share — Mohun Classification (Mohun 2005), external study (Wave 4).
...
def run():
    df = LOADER.load()
    print(f"    [L01_XS1402] loaded {len(df)} rows; "
