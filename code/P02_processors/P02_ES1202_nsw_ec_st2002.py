"""P02_ES1202 — NSW / Employee Compensation (ST 2002) using S607 + cached NIPA T20100."""
...
def run():
    ...
    print(f"    [P02_ES1202] {len(df)} rows; NSW/EC: 1952={v_1952:.4f}, 1997={v_1997:.4f}; wrote {final_path.name}")
    return df
