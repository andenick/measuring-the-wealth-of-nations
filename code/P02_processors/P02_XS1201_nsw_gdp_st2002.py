"""P02_XS1201 — NSW / GDP (ST 2002) using S607 + cached NIPA 1.7.5 GDP.
...
def run():
    ...
    print(f"    [P02_XS1201] {len(df)} rows; NSW/GDP: 1952={v_1952:.4f}, 1997={v_1997:.4f}, 2024={v_2024:.4f}; wrote {final_path.name}")
    return df
