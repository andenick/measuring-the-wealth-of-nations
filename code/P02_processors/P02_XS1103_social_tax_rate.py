"""P02_XS1103 — Social Tax Rate (S&T 1987) (derived ratio).
...
def run():
    ...
    print(f"    [P02_XS1103] {len(df)} rows; first={df.iloc[0]['value']:.4f}, last={df.iloc[-1]['value']:.4f}; wrote {final_path.name}")
    return df
