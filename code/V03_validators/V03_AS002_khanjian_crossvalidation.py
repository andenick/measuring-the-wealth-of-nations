"""V03_AS002 - Khanjian cross-validation against registry year anchors.
...
Refactored 2026-05-23 per Decision 0008:
  ...
  - AS002's `validation.reference_values` is already year-keyed (the five IO
    ...
    AS002-A column (rate of surplus value via Khanjian decomposition).
  - `validation.derived_statistics` is currently empty for AS002.
"""
...
def run():
    ...
    result = {
        ...
        "anchors": {
            ...
            "rule": ("AS002-A column (rate of surplus value via Khanjian "
