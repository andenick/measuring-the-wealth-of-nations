...
the Wealth of Nations replication. Subcommands:
    ...
    validate     Invoke anu-doctor project mode (Council/Druck) or manual audit.
...
ANU_DOCTOR_PATH = Path("<workspace>/Council/Druck/.claude/skills/anu-doctor/check_project.py")
