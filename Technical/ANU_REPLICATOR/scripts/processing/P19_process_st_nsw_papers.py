...
def process():
    ...
    if t604 is not None and t605 is not None and comp is not None:
        ...
        if common:
            ...
            out.index.name = "year"
            (SERIES_OUT / "N1101.csv").open("w").close()  # ensure exists
            out.to_csv(SERIES_OUT / "N1101.csv")
            data_dict["N1101"] = net_transfer
            outputs.append(str(SERIES_OUT / "N1101.csv"))
        ...
        if common:
            ...
            out.index.name = "year"
            out.to_csv(SERIES_OUT / "N1102.csv")
            data_dict["N1102"] = benefit_rate
            outputs.append(str(SERIES_OUT / "N1102.csv"))
        ...
        if common:
            ...
            out.index.name = "year"
            out.to_csv(SERIES_OUT / "N1103.csv")
            data_dict["N1103"] = tax_rate
            outputs.append(str(SERIES_OUT / "N1103.csv"))
    ...
    if t607 is not None and comp is not None:
        ...
        if gdp_path.exists():
            ...
            if not gdp_rows.empty:
                ...
                if common:
                    ...
                    out.index.name = "year"
                    out.to_csv(SERIES_OUT / "N1201.csv")
                    data_dict["N1201"] = nsw_gdp
                    outputs.append(str(SERIES_OUT / "N1201.csv"))
        ...
        if common:
            ...
            out.index.name = "year"
            out.to_csv(SERIES_OUT / "N1202.csv")
            data_dict["N1202"] = nsw_ec
            outputs.append(str(SERIES_OUT / "N1202.csv"))
