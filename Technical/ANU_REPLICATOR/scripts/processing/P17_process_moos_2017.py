...
N1303: Unemployment intensity (from FRED/BLS)
...
def process():
    ...
    if "N1301" in data_dict:
        ...
        post = nsw[(nsw.index >= 2001) & (nsw.index <= 2012)]
