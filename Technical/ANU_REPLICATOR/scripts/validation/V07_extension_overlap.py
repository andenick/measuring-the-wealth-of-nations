...
from lib.paths import SERIES_OUT, TECHNICAL
...
def validate(series_filter=None, chapter_filter=None):
    ...
    for ext in extensions:
        ...
        # Look for book-period column (A suffix) and extension column (EXT suffix)
        book_col = None
        ext_col = None
        ...
        # If we can't find distinct book/ext columns, check for overlap differently
