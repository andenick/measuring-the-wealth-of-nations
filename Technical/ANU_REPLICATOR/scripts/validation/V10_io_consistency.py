...
def validate(series_filter=None, chapter_filter=None):
    ...
    try:
        from lib.io.naics_parser import extract_use_matrix, extract_leontief, compute_technical_coefficients_naics
        from lib.io.naics_classification import classify_naics_sectors
    ...
    # Check 5: Labor values all positive (from T701 summary)
