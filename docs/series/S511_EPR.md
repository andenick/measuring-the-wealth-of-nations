...
Cached at `Inputs/ST2/Inputs/API_Data/BLS/bls_ces_production_workers.csv` (10 series, 77 rows), pulled 2026-02-24 (provenance: `pull_bls_ces.py`). Complementary BEA NIPA employment by industry (`nipa_6_4D_ftpt_by_industry.csv`, `nipa_6_5D_fte_by_industry.csv`) supports cross-validation.
