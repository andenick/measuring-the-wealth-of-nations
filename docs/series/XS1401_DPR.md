# XS1401 — Exploitation Rate — Mohun 2005
...
data/source/external_studies/Mohun_mohun_exploitation_rates_1948_1989_CORRECTED.csv
  -> L01_XS1401 -> data/intermediate/XS1401.csv
  -> P02_XS1401 -> data/final/XS1401.csv
  -> V03_XS1401 -> data/intermediate/validation/XS1401.json
```
