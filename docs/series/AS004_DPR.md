...
- **No EPR yet authored** for AS004 (Stage 4 work)
...
- **Original research**: `Technical/research/AS004_research.json`, researcher `agent`, 2026-05-16; verbatim quotes already present (Appendix I Table I.1, Appendix J Table J.1, salvaged page 140) — research JSON is well-anchored
