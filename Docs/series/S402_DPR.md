...
- S701/S702 consume this B matrix for sector-disaggregated labor values (`hp* · B`); the v1.0 aggregate-scalar proxy `mean(column_sum(B))` was retired in DIV-011 (see S701/S702 DPRs). S402 itself is a faithful computation of B given S401's A
