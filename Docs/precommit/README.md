...
Decision document under `Council/Druck/docs/decisions/` (the canonical
location for all framework + project-scoped decisions; see
`Council/Druck/docs/decisions/README.md`).

## References

- `Council/Druck/docs/decisions/0007_verbatim_quote_schema.md`
- `Council/Druck/docs/decisions/0008_reference_values_year_keyed_scalars.md` (moved from `Technical/docs/decisions/` to canonical Council location in v1.2 iter2)
