...
* Decision 0002 (registry-as-source-of-truth for benchmarks) — now archived per `Council/Druck/docs/decisions/README.md`; concepts live in `SERIES_REGISTRY_SCHEMA.md`
